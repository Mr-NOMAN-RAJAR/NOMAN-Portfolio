...
import bgcover from "../../public/1393206.jpg";

const Contact = () => {
  return (
    <section id="Contect" className="relative py-16 bg-gradient-to-br from-orange-200 via-sky-800 to-pink-600 " >
      ...
      <div className="relative max-w-5xl mx-auto p-8 z-10 grid grid-cols-1 md:grid-cols-2 gap-8">
       
        <div
          className="justify-items-flex-center bg-opacity-90 shadow-lg rounded-lg p-6 space-y-6 transform hover:-translate-y-1 transition-transform duration-300"
        >
        ...
        <div className="bg-slate- bg-opacity-90 shadow-lg rounded-lg p-6 space-y-6 transform hover:-translate-y-1 transition-transform duration-300">
