    ...
    <div>
      <section id="projects" className="bg-slate-950  py-12 ">
        ...
        <div className=" grid gap-8 lg:grid-cols-2 max-w-6xl mx-auto px-4">
          ...
          <div className=" block-div bg-gradient-to-r from-indigo-400 to-purple-700 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
          ...
          <div className=" bg-gradient-to-r from-indigo-400 to-purple-700 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
